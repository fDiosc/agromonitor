...
export default function NewFieldPage() {
  ...
  const [drawnCentroid, setDrawnCentroid] = useState<{ lat: number; lng: number } | null>(null)
  ...
  const handleSubmit = async (e?: React.MouseEvent) => {
    ...
    console.log('Submit - geometryJson:', currentGeometry ? `${currentGeometry.length} chars` : 'null')
    console.log('Submit - finalArea:', finalArea)
    ...
    try {
      ...
      console.log('Sending payload:', {
        ...payload,
        geometryJson: `${payload.geometryJson.length} chars`
      })
      ...
      console.log('Field created:', data.field.id)
